...
// Apple 系統優先：顯示與複製都保留來源的原始 Unicode，
// 不在程式中將特殊字元強制換成近似字形。
...
const curatedCuteKaomojis = [
  ...
  { text: 'ᵔ⤙ᵔ', tags: ['人物', '可愛', '極簡'] },
  { text: 'Z☡zᶻ', tags: ['晚安', '可愛', '特殊'] },
  { text: '⌯>ᴗo⌯ಣ', tags: ['可愛', '人物', '特殊'] },
  { text: "⌯'Ⱉ'⌯", tags: ['可愛', '人物', '特殊'] },
  { text: '⸝⸝⸝ ╸▵╺⸝⸝⸝', tags: ['可愛', '裝飾', '特殊'] },
  { text: '・・', tags: ['符號', '極簡', '特殊'] },
  { text: '⑉꒦ິ^꒦ິ⑉', tags: ['哭', '難過', '可愛'] },
  { text: '⌯>ᴗ<⌯ಣ', tags: ['可愛', '人物', '特殊'] },
  { text: '੧ᐛ੭', tags: ['手勢', '可愛', '打招呼'] },
  { text: '⁰̷̴͈꒨⁰̷̴͈', tags: ['可愛', '人物', '特殊'] },
  { text: '📿⁰̷̴͈ᴥ⁰̷̴͈📿', tags: ['動物', '可愛', '特殊'] },
  { text: '˃̵ ֊ ˂̵', tags: ['人物', '可愛', '極簡'] },
  { text: 'o̴̶̷᷄ ·̭ o̴̶̷̥᷅', tags: ['哭', '難過', '可愛'] },
  { text: '˃̵͈᷄ ᎔ ˂̵͈᷅', tags: ['人物', '可愛', '特殊'] },
  { text: '’▾‘', tags: ['人物', '可愛', '極簡'] },
  { text: '>ᯅ<', tags: ['人物', '可愛', '極簡'] },
  { text: '•͈ ₃ •͈', tags: ['動物', '可愛', '極簡'] },
  { text: 'ദ്ദി˶ｰ̀֊ｰ́ ) ✧', tags: ['手勢', '加油', '可愛'] },
  { text: 'ど⁰̷̴͈꒨⁰̷̴͈う♡', tags: ['愛心', '可愛', '聊天'] },
  { text: '^ ̳> ·̫ < ̳^', tags: ['動物', '貓', '可愛'] },
  { text: '๑>ᴗO๑', tags: ['人物', '可愛', '開心'] },
  { text: '=• ֊ •=', tags: ['動物', '貓', '可愛'] },
  { text: 'ꉂ ･ ･ ☆', tags: ['人物', '可愛', '星星'] },
  { text: '˃̵͈̑ᴗ˂̵͈̑', tags: ['人物', '可愛', '開心'] },
  { text: '𖦹𖦹 .ᐟ.ᐟ', tags: ['人物', '可愛', '特殊'] },
  { text: '^ ̳- ‧̫ • ̳^ฅ', tags: ['動物', '貓', '可愛'] },
  { text: '^•ω<^ ੭', tags: ['動物', '貓', '可愛'] },
  { text: '^⌯𖥦⌯^੭', tags: ['動物', '貓', '可愛'] },
  { text: 'ᜊ꒰๑˃͈꒵˂͈๑꒱ᜊ', tags: ['動物', '可愛', '特殊'] },
  { text: "ᖰ⌯'▾'⌯ᖳ", tags: ['人物', '可愛', '特殊'] },
  { text: '⸝⸝>⩊<⸝⸝', tags: ['人物', '可愛', '特殊', '已修復'] },
  { text: '૮⑉･-･⑉ა', tags: ['動物', '可愛', '特殊'] },
  { text: '✩*:.⸝⸝>o<⸝⸝.:*✩', tags: ['星星', '可愛', '裝飾'] },
  { text: '• ︡ᯅ•︠', tags: ['人物', '可愛', '特殊'] },
  { text: 'ᗦ↞︎◃︎', tags: ['動物', '可愛', '特殊'] },
  { text: '߹ᯅ߹', tags: ['哭', '難過', '可愛'] },
  { text: '(,,• ֊ •,,)♡', tags: ['愛心', '可愛', '人物'] },
  { text: '꜀(^. .^꜀ )꜆੭', tags: ['動物', '貓', '可愛'] },
  { text: '(⁠◍⁠•⁠ᴗ⁠•⁠◍⁠)', tags: ['人物', '可愛', '柔和'] },
  { text: '˚⊹ ⁺‧( *´꒳`*)‧⁺ ⊹˚', tags: ['可愛', '裝飾', '開心'] },
  { text: '(๑´ㅂ`๑)', tags: ['人物', '可愛', '開心'] },
  { text: '(ू•ᴗ•ू❁)', tags: ['人物', '可愛', '花朵'] },
  { text: '˛ꉂ ೭(˵¯̴͒ꇴ¯̴͒˵)౨”', tags: ['人物', '可愛', '特殊'] },
  ...
  { text: '(ꐦ°д°)', tags: ['人物', '生氣', '特殊', '已修復'] },
  { text: '｡ﾟ♡ﾟ｡(｡>‿‿<｡ )｡ﾟ♡ﾟ｡', tags: ['愛心', '可愛', '裝飾'] },
  { text: '(ง ´౪`)ว', tags: ['人物', '開心', '加油', '已修復'] },
  { text: '(*ﾟ∀ﾟ*)ノ', tags: ['人物', '開心', '打招呼'] },
  { text: '*.✧(ﾟ∇ﾟ)✧.*', tags: ['星星', '開心', '裝飾'] },
  { text: '(ง°ل°)ง', tags: ['人物', '手勢', '加油', '已修復'] },
  { text: '٩(°ل°)۶', tags: ['人物', '手勢', '加油', '特殊', '已修復'] },
  // 文章中可跨平台使用的純文字款，僅保留不依賴圖片或組合符號的顏文字。
  { text: '(^▽^)', tags: ['人物', '開心', '極簡'] },
  { text: '(^o^)', tags: ['人物', '開心', '極簡'] },
  { text: '(≧ω≦)', tags: ['人物', '可愛', '開心'] },
  { text: '(≧∇≦)', tags: ['人物', '可愛', '開心'] },
  { text: '(≧∀≦)', tags: ['人物', '可愛', '開心'] },
  { text: '(*^▽^*)', tags: ['人物', '可愛', '開心'] },
  { text: '(*^ω^*)', tags: ['人物', '可愛', '開心'] },
  { text: '(｡◕‿◕｡)', tags: ['人物', '可愛', '柔和'] },
  { text: '(◕‿◕)', tags: ['人物', '可愛', '極簡'] },
  { text: '(´▽｀)', tags: ['人物', '開心', '柔和'] },
  { text: '(￣ω￣)', tags: ['人物', '極簡', '聊天'] },
  { text: '(•‿•)ノ', tags: ['人物', '打招呼', '可愛'] },
  { text: 'ヽ(＾▽＾)ﾉ', tags: ['人物', '打招呼', '開心'] },
  { text: 'ヽ(≧▽≦)ﾉ', tags: ['人物', '打招呼', '開心'] },
  { text: '＼(＾∀＾)／', tags: ['人物', '開心', '手勢'] },
  { text: '٩(◕‿◕｡)۶', tags: ['人物', '手勢', '可愛'] },
  { text: 'ฅ(=･ω･=)ฅ', tags: ['動物', '貓', '可愛'] },
  { text: 'U^ｪ^U', tags: ['動物', '狗', '可愛'] },
  { text: '(•ㅅ•)', tags: ['動物', '兔子', '可愛'] },
  { text: '(•ө•)', tags: ['動物', '鳥', '可愛'] },
  { text: 'ʕ•ᴥ•ʔ', tags: ['動物', '熊', '可愛'] },
